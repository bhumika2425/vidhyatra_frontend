    ...
    return Column(
      ...
      children: [
        ...
        Obx(() => Row(
          ...
          children: [
            _buildStatCard("Total Users", controller.totalUsers.value.toString(), Colors.blue),
            _buildStatCard("Total Events", controller.totalEvents.value.toString(), Colors.green),
            _buildStatCard("Feedbacks", controller.totalFeedbacks.value.toString(), Colors.orange),
          ],
        )),
        SizedBox(height: 30),
