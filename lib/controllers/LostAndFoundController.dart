...
class LostFoundController extends GetxController {
  ...
  Future<void> fetchLostAndFoundItems() async {
    try {
      isLoading.value = true;
      final response = await http.get(
        Uri.parse('${ApiEndPoints.baseUrl}/api/lost-and-found/fetchAll'),
        headers: _headers,
      );
  ...
  Future<void> createLostFoundItem(LostFoundItem item) async {
    try {
      ...
      final uri = Uri.parse('${ApiEndPoints.baseUrl}/api/lost-and-found/create');
      final request = http.MultipartRequest('POST', uri);
  ...
  Future<void> updateLostFoundItem(int id, LostFoundItem item) async {
    try {
      ...
      final uri = Uri.parse('${ApiEndPoints.baseUrl}/api/lost-and-found/updateById/$id');
      final request = http.MultipartRequest('PUT', uri);
  ...
  Future<void> deleteLostFoundItem(int id) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('${ApiEndPoints.baseUrl}/api/lost-and-found/deleteById/$id'),
        headers: _headers,
      );
